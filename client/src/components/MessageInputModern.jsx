...
import './MessageInputModern.css';

const MessageInputModern = ({ onSendMessage, disabled = false }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="msg-input-modern">
      ...
      <button
        type="submit"
        className={`send-btn-modern ${message.trim() ? 'active' : ''}`}
...
export default MessageInputModern;
